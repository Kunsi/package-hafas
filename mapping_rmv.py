...
MAPPING_RMV = {
    "ESW": {
        "Bus 1": (Helper.hex2rgb("f39433"), (1,1,1)),
        "Bus 2": (Helper.hex2rgb("00a7e7"), (1,1,1)),
        "Bus 3": (Helper.hex2rgb("ddae8d"), (1,1,1)),
        "Bus 4": (Helper.hex2rgb("64b445"), (1,1,1)),
        "Bus 5": (Helper.hex2rgb("5da5b8"), (1,1,1)),
        "Bus 6": (Helper.hex2rgb("d51317"), (1,1,1)),
        "Bus 8": (Helper.hex2rgb("f39433"), (1,1,1)),
        "Bus 9": (Helper.hex2rgb("a94f2b"), (1,1,1)),
        "Bus 14": (Helper.hex2rgb("64b445"), (1,1,1)),
        "Bus 15": (Helper.hex2rgb("5da5b8"), (1,1,1)),
        "Bus 16": (Helper.hex2rgb("f0988f"), (0,0,0)),
        "Bus 17": (Helper.hex2rgb("5c2483"), (1,1,1)),
        "Bus 18": (Helper.hex2rgb("ea5b0c"), (1,1,1)),
        "Bus 20": (Helper.hex2rgb("acb371"), (1,1,1)),
        "Bus 21": (Helper.hex2rgb("d1b122"), (1,1,1)),
        "Bus 22": (Helper.hex2rgb("d1b122"), (1,1,1)),
        "Bus 23": (Helper.hex2rgb("0086cd"), (1,1,1)),
        "Bus 24": (Helper.hex2rgb("0086cd"), (0,0,0)),
        "Bus 26": (Helper.hex2rgb("adce6d"), (1,1,1)),
        "Bus 27": (Helper.hex2rgb("cd7bab"), (1,1,1)),
        "Bus 28": (Helper.hex2rgb("5bc5f2"), (1,1,1)),
        "Bus 30": (Helper.hex2rgb("ba0161"), (1,1,1)),
        "Bus 33": (Helper.hex2rgb("ddae8d"), (1,1,1)),
        "Bus 34": (Helper.hex2rgb("9097c3"), (1,1,1)),
        "Bus 37": (Helper.hex2rgb("9f4c97"), (1,1,1)),
        "Bus 38": (Helper.hex2rgb("009a93"), (1,1,1)),
        "Bus 39": (Helper.hex2rgb("e7344c"), (1,1,1)),
        "Bus 43": (Helper.hex2rgb("ffd500"), (1,1,1)),
        "Bus 45": (Helper.hex2rgb("acb371"), (0,0,0)),
        "Bus 46": (Helper.hex2rgb("516fb4"), (1,1,1)),
        "Bus 47": (Helper.hex2rgb("006f8c"), (1,1,1)),
        "Bus 48": (Helper.hex2rgb("fab437"), (1,1,1)),
        "Bus 49": (Helper.hex2rgb("8ec799"), (0,0,0)),
    ...
    "MVG": {
        "Bus 6": (Helper.hex2rgb("cb5e10"), (1,1,1)),
        "Bus 9": (Helper.hex2rgb("d6d000"), (1,1,1)),
        "Bus 28": (Helper.hex2rgb("f7a600"), (0,0,0)),
        "Bus 33": (Helper.hex2rgb("232c77"), (1,1,1)),
