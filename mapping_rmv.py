...
MAPPING_RMV = {
    "ESW": {
        ...
        "E1": (Helper.hex2rgb("f39433"), (1, 1, 1)),
        "E2": (Helper.hex2rgb("00a7e7"), (1, 1, 1)),
        "E3": (Helper.hex2rgb("8c5694"), (1, 1, 1)),
        "E4": (Helper.hex2rgb("64b445"), (1, 1, 1)),
        "E5": (Helper.hex2rgb("5da5b8"), (1, 1, 1)),
        "E6": (Helper.hex2rgb("cb5e10"), (1, 1, 1)),
        "E8": (Helper.hex2rgb("f39433"), (1, 1, 1)),
        "E9": (Helper.hex2rgb("a94f2b"), (1, 1, 1)),
        "E14": (Helper.hex2rgb("64b445"), (1, 1, 1)),
        "E15": (Helper.hex2rgb("5da5b8"), (1, 1, 1)),
        "E16": (Helper.hex2rgb("f0988f"), (0, 0, 0)),
        "E17": (Helper.hex2rgb("5c2483"), (1, 1, 1)),
        "E18": (Helper.hex2rgb("ea5b0c"), (1, 1, 1)),
        "E20": (Helper.hex2rgb("acb371"), (1, 1, 1)),
        "E21": (Helper.hex2rgb("d1b122"), (1, 1, 1)),
        "E22": (Helper.hex2rgb("d1b122"), (1, 1, 1)),
        "E23": (Helper.hex2rgb("0086cd"), (1, 1, 1)),
        "E24": (Helper.hex2rgb("0086cd"), (0, 0, 0)),
        "E26": (Helper.hex2rgb("adce6d"), (1, 1, 1)),
        "E27": (Helper.hex2rgb("cd7bab"), (1, 1, 1)),
        "E28": (Helper.hex2rgb("5bc5f2"), (1, 1, 1)),
        "E30": (Helper.hex2rgb("ba0161"), (1, 1, 1)),
        "E33": (Helper.hex2rgb("ddae8d"), (1, 1, 1)),
        "E34": (Helper.hex2rgb("9097c3"), (1, 1, 1)),
        "E37": (Helper.hex2rgb("9f4c97"), (1, 1, 1)),
        "E38": (Helper.hex2rgb("009a93"), (1, 1, 1)),
        "E39": (Helper.hex2rgb("e7344c"), (1, 1, 1)),
        "E43": (Helper.hex2rgb("ffd500"), (1, 1, 1)),
        "E45": (Helper.hex2rgb("acb371"), (0, 0, 0)),
        "E46": (Helper.hex2rgb("516fb4"), (1, 1, 1)),
        "E47": (Helper.hex2rgb("006f8c"), (1, 1, 1)),
        "E48": (Helper.hex2rgb("fab437"), (1, 1, 1)),
        "E49": (Helper.hex2rgb("8ec799"), (0, 0, 0)),
    ...
    # express buses have global colours
    "X11": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X14": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X15": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X17": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X18": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X19": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X26": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X27": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X33": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X35": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X37": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X38": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X39": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X41": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X53": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X57": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X58": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X61": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X64": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X69": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X71": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X72": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X74": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X76": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X77": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X78": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X83": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X89": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X93": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X94": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
    "X95": (Helper.hex2rgb("e7007a"), (1, 1, 1)),
}
