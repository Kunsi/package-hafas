...
from mapping_saarvv import MAPPING_SAARVV
from mapping_vbb import MAPPING_VBB

COLOUR_MAPPING = {
    "rmv": MAPPING_RMV,
    "saarvv": MAPPING_SAARVV,
    "vbb": MAPPING_VBB,
...
API_MAPPING = {
    ...
    "saarvv": "https://www.saarfahrplan.de/restproxy/{endpoint}?id={stop}&duration={minutes}&format=json&accessId={key}",
